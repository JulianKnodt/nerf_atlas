...
dyn_voxel: clean
	...
	--near 2 --far 6 --batch-size 1 --crop-size 64 --model voxel --dyn-model voxel -lr 1e-3 \
	--loss-fns l2 --test-crop-size 96 --depth-images --flow-map --spline 4 --steps 60 \
  --voxel-tv-sigma 1e-3 --voxel-tv-rgb 1e-5 --voxel-tv-bezier 1e-3 --voxel-tv-rigidity 1e-3 \
  --spline-len-decay 1e-3 --higher-end-chance 1 --offset-decay 1e-3 --ffjord-div-decay 1e-3 \
